      ...
      <div className={`container ${styles.container} animate`}>
        <div className={styles.content}>
          <h1 className={styles.title}>
            Tu Socio Estratégico en <span className="text-primary">Crecimiento y Escalamiento</span> Comercial
          </h1>
          <p className={styles.description}>
            Ayudamos a infoproductores y negocios digitales a escalar sus operaciones mediante estrategias de adquisición de clientes y optimización de infraestructura comercial.
          </p>
